...
# Biblioteca de planes
    def intentsData(self):
        ...
        self.intents.append(('say','utter_preguntar_cuando', ['utter_preguntar_cuando'], 'acc_del_belief','utter_preguntar_cuando', 'acc_say', 'utter_preguntar_cuando'))  
        self.intents.append(('say','utter_preguntar_por_que', ['utter_preguntar_por_que'], 'acc_del_belief','utter_preguntar_por_que', 'acc_say', 'utter_preguntar_por_que'))  
        self.intents.append(('say','utter_preguntar_quien', ['utter_preguntar_quien'], 'acc_del_belief','utter_preguntar_quien', 'acc_say', 'utter_preguntar_quien'))  
        self.intents.append(('say','utter_preguntar_como', ['utter_preguntar_como'], 'acc_del_belief','utter_preguntar_como', 'acc_say', 'utter_preguntar_como')) 
        self.intents.append(('say','utter_preguntar_donde', ['utter_preguntar_donde'], 'acc_del_belief','utter_preguntar_donde', 'acc_say', 'utter_preguntar_donde')) 
