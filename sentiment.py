...
class SentimentAnalyzer(Component):
    ...
    def process(self, message, **kwargs):        
        ...
        #print("aqui el mensaje:" + str(vars(message)))
        #define mensaje como cualquier accion que realiza el bot
        if not self.clf:
            ...
            tokens = []
            if message.data.get("text_tokens") is not None:            
                for t in message.data.get("text_tokens"):
